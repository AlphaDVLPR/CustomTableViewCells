...
//    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "settingCell", for: indexPath) as? CustomTableViewCell else { return UITableViewCell()}
...
extension SettingTableViewController: SettingTableViewViewCellDelegate {
